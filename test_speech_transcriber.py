"""Tests for speech_transcriber.py — pure functions and DAG logic."""
...
class TestMergeStructuredEndToEnd:
    ...
    @patch("speech_transcriber.api_call_with_retry")
...
class TestCheckpointFileIntegrity:
    ...
    @patch("speech_transcriber._build_wdiff_alignment")
    @patch("speech_transcriber.api_call_with_retry")
